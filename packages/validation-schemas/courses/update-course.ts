...
export const UpdateCourseApiRequestSchema = UpdateCourseFormSchema

export const UpdateCourseApiResponseSchema = z.object({
    message: z.string(),
})

export type UpdateCourseApiRequest = z.infer<typeof UpdateCourseApiRequestSchema>
export type UpdateCourseApiResponse = z.infer<typeof UpdateCourseApiResponseSchema>